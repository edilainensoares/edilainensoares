...
* Finalizei o Bootcamp [Analista de QA] pela instituição Triple Ten Brasil.
* Iniciando os estudos em automação de testes com Cypress/Selenium/Playwright.
* Atuando como QA Tester (Voluntário) no projeto Pipoca Ágil | Início em Set/2025. 

Conhecimentos & Ferramentas
* Testes Manuais: Escrita de Casos de Teste, Planos de Teste, Report de Bugs.
* Automação: Python e Selenium.
* Ferramentas: Jira, Postman (API), Git, GitHub.
* Metodologias: Scrum.
